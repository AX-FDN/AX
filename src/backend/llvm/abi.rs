...
pub(super) const HOST_HANDLE_HEADER_BYTES: i64 = 16;
pub(super) const HOST_HANDLE_KIND_OFFSET: i64 = 0;
pub(super) const HOST_HANDLE_NATIVE_OFFSET: i64 = 8;
pub(super) const TCP_SOCKET_HANDLE_KIND: i32 = 1;
pub(super) const TLS_STREAM_HANDLE_KIND: i32 = 2;
pub(super) const HTTP_CLIENT_HANDLE_KIND: i32 = 3;
pub(super) const HTTP_SERVER_HANDLE_KIND: i32 = 4;
pub(super) const DB_CONNECTION_HANDLE_KIND: i32 = 5;
pub(super) const ASYNC_TASK_HANDLE_KIND: i32 = 6;
pub(super) const TIMER_HANDLE_KIND: i32 = 7;
