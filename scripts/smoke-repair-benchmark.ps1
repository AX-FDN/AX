...
Assert-Equal -Label "runSummary.totals.total" -Actual ([int] $runSummary.totals.total) -Expected 13
Assert-Equal -Label "runSummary.totals.ok" -Actual ([int] $runSummary.totals.ok) -Expected 13
...
Assert-Equal -Label "runSummary.cases count" -Actual (@($runSummary.cases).Count) -Expected 13
...
Assert-Equal -Label "scoreSummary.totals.total" -Actual ([int] $scoreSummary.totals.total) -Expected 13
Assert-Equal -Label "scoreSummary.totals.passed" -Actual ([int] $scoreSummary.totals.passed) -Expected 13
...
Assert-Equal -Label "scoreSummary.cases count" -Actual (@($scoreSummary.cases).Count) -Expected 13
...
Assert-Equal -Label "check case count" -Actual $checkCases.Count -Expected 11
