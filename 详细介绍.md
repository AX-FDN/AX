...
- 想看更贴近“编译器/工具内部逻辑”的 AX 样例：看 [`examples/bootstrap_token_scan.ax`](./examples/bootstrap_token_scan.ax) 和 [`examples/bootstrap_state_machine.ax`](./examples/bootstrap_state_machine.ax)
