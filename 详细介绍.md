...
- 想直接照着例子练：看 [`examples/hello.ax`](./examples/hello.ax)、[`examples/arrays.ax`](./examples/arrays.ax)、[`examples/factorial.ax`](./examples/factorial.ax)、[`examples/for_loop.ax`](./examples/for_loop.ax)、[`examples/slices.ax`](./examples/slices.ax)、[`examples/string_tools.ax`](./examples/string_tools.ax)、[`examples/traversal.ax`](./examples/traversal.ax)、[`examples/format_report.ax`](./examples/format_report.ax)、[`examples/token_rewrite.ax`](./examples/token_rewrite.ax)、[`examples/syntax_overview.ax`](./examples/syntax_overview.ax)
